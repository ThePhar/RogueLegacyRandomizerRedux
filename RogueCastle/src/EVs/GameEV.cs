...
internal static class GameEV
{
    ...
    // The PERCENT of your money that the gate keeper takes when you restart a castle.
    ...
    public const float NEWGAMEPLUS_GOLDBOUNTY = 0.5f; //0.1f; 
    ...
    //The amount of lifedrain you get per enemy kill per vampirism rune.
    ...
    public const float DRAGON_MANAGAIN = 4; 

    // The amount of mana the spelunker loses while the light is on PER SECOND. DOES NOT USE TIC RATE.
    ...
    // 2 percent chance of enemy dropping health or mana on death.
