...
internal static class SpellEV
{
    ...
    public static int GetManaCost(byte spellType)
    {
        switch (spellType)
        {
            ...
            case SpellType.Axe:
                return AXE_Cost;
            case SpellType.TimeBomb:
                return TIMEBOMB_Cost;
            case SpellType.TimeStop:
                return TIMESTOP_Cost;
            case SpellType.Nuke:
                return NUKE_Cost;
            case SpellType.Translocator:
                return TRANSLOCATER_Cost;
            case SpellType.Displacer:
                return DISPLACER_Cost;
            case SpellType.Boomerang:
                return BOOMERANG_Cost;
            case SpellType.DualBlades:
                return DUAL_BLADES_Cost;
            case SpellType.Close:
                return CLOSE_Cost;
            case SpellType.DamageShield:
                return DAMAGE_SHIELD_Cost;
            case SpellType.Bounce:
                return BOUNCE_Cost;
            case SpellType.Laser:
                return LASER_Cost;
            case SpellType.DragonFire:
                return DRAGONFIRE_Cost;
            case SpellType.DragonFireNeo:
                return DRAGONFIRENEO_Cost;
            case SpellType.RapidDagger:
                return RAPIDDAGGER_Cost;
        }
    ...
    public static int GetRarity(byte spellType)
    {
        ...
        {
            case SpellType.Dagger:
                return DAGGER_Rarity;
            case SpellType.Axe:
                return AXE_Rarity;
            case SpellType.TimeBomb:
                return TIMEBOMB_Rarity;
            case SpellType.TimeStop:
                return TIMESTOP_Rarity;
            case SpellType.Nuke:
                return NUKE_Rarity;
            case SpellType.Translocator:
                return TRANSLOCATER_Rarity;
            case SpellType.Displacer:
                return DISPLACER_Rarity;
            case SpellType.Boomerang:
                return BOOMERANG_Rarity;
            case SpellType.DualBlades:
                return DUAL_BLADES_Rarity;
            case SpellType.Close:
                return CLOSE_Rarity;
            case SpellType.DamageShield:
                return DAMAGE_SHIELD_Rarity;
            case SpellType.Bounce:
                return BOUNCE_Rarity;
            case SpellType.Laser:
                return LASER_Rarity;
            case SpellType.DragonFire:
                return DRAGONFIRE_Rarity;
            case SpellType.DragonFireNeo:
                return DRAGONFIRENEO_Rarity;
            case SpellType.RapidDagger:
                return RAPIDDAGGER_Rarity;
        }
    ...
    public static float GetDamageMultiplier(byte spellType)
    {
        switch (spellType)
        {
            ...
            case SpellType.Axe:
                return AXE_Damage;
            case SpellType.TimeBomb:
                return TIMEBOMB_Damage;
            case SpellType.TimeStop:
                return TIMESTOP_Damage;
            case SpellType.Nuke:
                return NUKE_Damage;
            case SpellType.Translocator:
                return TRANSLOCATER_Damage;
            case SpellType.Displacer:
                return DISPLACER_Damage;
            case SpellType.Boomerang:
                return BOOMERANG_Damage;
            case SpellType.DualBlades:
                return DUAL_BLADES_Damage;
            case SpellType.Close:
                return CLOSE_Damage;
            case SpellType.DamageShield:
                return DAMAGE_SHIELD_Damage;
            case SpellType.Bounce:
                return BOUNCE_Damage;
            case SpellType.Laser:
                return LASER_Damage;
            case SpellType.DragonFire:
                return DRAGONFIRE_Damage;
            case SpellType.DragonFireNeo:
                return DRAGONFIRENEO_Damage;
            case SpellType.RapidDagger:
                return RAPIDDAGGER_Damage;
        }
    ...
    public static float GetXValue(byte spellType)
    {
        switch (spellType)
        {
            ...
            case SpellType.Axe:
                return AXE_XVal;
            case SpellType.TimeBomb:
                return TIMEBOMB_XVal;
            case SpellType.TimeStop:
                return TIMESTOP_XVal;
            case SpellType.Nuke:
                return NUKE_XVal;
            case SpellType.Translocator:
                return TRANSLOCATER_XVal;
            case SpellType.Displacer:
                return DISPLACER_XVal;
            case SpellType.Boomerang:
                return BOOMERANG_XVal;
            case SpellType.DualBlades:
                return DUAL_BLADES_XVal;
            case SpellType.Close:
                return CLOSE_XVal;
            case SpellType.DamageShield:
                return DAMAGE_SHIELD_XVal;
            case SpellType.Bounce:
                return BOUNCE_XVal;
            case SpellType.Laser:
                return LASER_XVal;
            case SpellType.DragonFire:
                return DRAGONFIRE_XVal;
            case SpellType.DragonFireNeo:
                return DRAGONFIRENEO_XVal;
        }
    ...
    public static float GetYValue(byte spellType)
    {
        switch (spellType)
        {
            ...
            case SpellType.Axe:
                return AXE_YVal;
            case SpellType.TimeBomb:
                return TIMEBOMB_YVal;
            case SpellType.TimeStop:
                return TIMESTOP_YVal;
            case SpellType.Nuke:
                return NUKE_YVal;
            case SpellType.Translocator:
                return TRANSLOCATER_YVal;
            case SpellType.Displacer:
                return DISPLACER_YVal;
            case SpellType.Boomerang:
                return BOOMERANG_YVal;
            case SpellType.DualBlades:
                return DUAL_BLADES_YVal;
            case SpellType.Close:
                return CLOSE_YVal;
            case SpellType.DamageShield:
                return DAMAGE_SHIELD_YVal;
            case SpellType.Bounce:
                return BOUNCE_YVal;
            case SpellType.Laser:
                return LASER_YVal;
            case SpellType.DragonFire:
                return DRAGONFIRE_YVal;
            case SpellType.DragonFireNeo:
                return DRAGONFIRENEO_YVal;
        }
