...
namespace RogueCastle
{
    ...
    public class Game : Microsoft.Xna.Framework.Game
    {
                    ...
                    if (LevelEV.LoadTitleScreen == false)
                    {
                        ...
                        else
                        {
                            if (LevelEV.RunTutorial == true)
                                ScreenManager.DisplayScreen(ScreenType.TUTORIAL_ROOM, true, null);
                            else
                                //ScreenManager.DisplayScreen(ScreenType.Lineage, true, null); // Just for testing lineages.
                                ScreenManager.DisplayScreen(ScreenType.STARTING_ROOM, true, null);
                            //ScreenManager.DisplayScreen(ScreenType.Ending, true, null);
        ...
        public void InitializeMaleNameArray(bool forceCreate)
        {
            ...
            if ((m_maleChineseNamesLoaded == false && LocaleBuilder.LanguageType == LanguageType.ChineseSimple) ||
                (m_maleChineseNamesLoaded == true && LocaleBuilder.LanguageType != LanguageType.ChineseSimple))
                forceCreate = true;
        ...
        {
            // The name list needs to be reloaded every time the language is from Chinese to another language or vice versa.
            if ((m_femaleChineseNamesLoaded == false && LocaleBuilder.LanguageType == LanguageType.ChineseSimple) ||
                (m_femaleChineseNamesLoaded == true && LocaleBuilder.LanguageType != LanguageType.ChineseSimple))
                forceCreate = true;
        ...
        public static string NameHelper(string playerName, string romanNumerals, bool isFemale, bool forceConversionCheck = false)
        {
            ...
            if (isFemale == true)
            {
                if (LocaleBuilder.LanguageType == LanguageType.ChineseSimple && (romanNumerals == "" || romanNumerals == null))
