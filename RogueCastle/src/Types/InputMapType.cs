...
public static class InputHelper
{
    public static bool PressedConfirm() =>
        Game.GlobalInput.JustPressed(InputMapType.MENU_CONFIRM1) ||
    ...
    public static bool PressedCancel() =>
        Game.GlobalInput.JustPressed(InputMapType.MENU_CANCEL1) ||
    ...
    public static bool PressedUp() =>
        Game.GlobalInput.JustPressed(InputMapType.PLAYER_UP1) ||
        Game.GlobalInput.JustPressed(InputMapType.PLAYER_UP2);
        
    public static bool PressedDown() =>
        Game.GlobalInput.JustPressed(InputMapType.PLAYER_DOWN1) ||
        Game.GlobalInput.JustPressed(InputMapType.PLAYER_DOWN2);
        
    public static bool PressedLeft() =>
        Game.GlobalInput.JustPressed(InputMapType.PLAYER_LEFT1) ||
        Game.GlobalInput.JustPressed(InputMapType.PLAYER_LEFT2);
        
    public static bool PressedRight() =>
        Game.GlobalInput.JustPressed(InputMapType.PLAYER_RIGHT1) ||
        Game.GlobalInput.JustPressed(InputMapType.PLAYER_RIGHT2);
}
