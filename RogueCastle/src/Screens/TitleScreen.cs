...
public class TitleScreen : Screen
{
    ...
    private TextObj               _gameVersionNumber;
    private TextObj               _rlrxVersionNumber;
    ...
    public override void LoadContent()
    {
        ...
        //_godRay = new CrepuscularRays(ScreenManager.Game, Vector2.One * .5f, "GameSpritesheets/flare3", 2f, .97f, .97f, .5f, .75f);
        ...
        _pressStartText2.Align = Types.TextAlign.Centre;
        _pressStartText2.Position = _pressStartText.Position;
        ...
        _profileSelectKey.Position = new Vector2(30, 15);
    ...
    public override void OnEnter()
    {
        ...
        Camera.Zoom = 1;
        _profileSelectKey.Text = string.Format(LocaleBuilder.getResourceString("LOC_ID_BACK_TO_MENU_OPTIONS_3_NEW"),
            Game.GameConfig.ProfileSlot);
    ...
    {
        _copyrightText.ChangeFontNoDefault(LocaleBuilder.GetLanguageFont(_copyrightText));
        _copyrightText.Text = LocaleBuilder.getResourceString("LOC_ID_COPYRIGHT_GENERIC", true) + " " +
                              string.Format(LocaleBuilder.getResourceString("LOC_ID_TRADEMARK_GENERIC", true),
                                  "Rogue Legacy");
    }
    ...
    {
        _pressStartText2.ChangeFontNoDefault(LocaleBuilder.GetLanguageFont(_pressStartText));
        ...
        if (_startNewLegacy == false)
        {
            ...
            if (_heroIsDead == false)
            {
                ...
                {
                    _pressStartText2.Text = LocaleBuilder.getResourceString("LOC_ID_TITLE_SCREEN_2") + " +";
                }
            ...
            else // You have an active character but he died. Go to legacy screen.
            {
                if (Game.PlayerStats.TimesCastleBeaten == 1)
                {
                    _pressStartText2.Text = LocaleBuilder.getResourceString("LOC_ID_TITLE_SCREEN_3", true) + " +";
                }
                else if (Game.PlayerStats.TimesCastleBeaten > 1)
                {
                    _pressStartText2.Text = LocaleBuilder.getResourceString("LOC_ID_TITLE_SCREEN_3", true) + " +" +
    ...
    public override void Draw(GameTime gameTime)
    {
        ...
        _gameVersionNumber.Draw(Camera);
        _rlrxVersionNumber.Draw(Camera);
    ...
    public override void Dispose()
    {
        if (IsDisposed == false)
        {
            ...
            _copyrightText = null;
            _gameVersionNumber.Dispose();
            _gameVersionNumber = null;
            _rlrxVersionNumber.Dispose();
            _rlrxVersionNumber = null;
            _titleText.Dispose();
            _titleText = null;
